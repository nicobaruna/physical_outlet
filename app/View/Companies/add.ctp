		...
		<form class="form-horizontal">
		  ...
		  <table class="table table-hovered">
					...
					<div class="control-group">
					  <div class="controls">
						<!--<label class="checkbox-inline">
						  <input type="checkbox" name="" id="ktpcheck" value="">
						  KTP
						</label>
						<label class="checkbox-inline">
						  <input type="checkbox" name="" id="simcheck" value="">
						  SIM
						</label>
						<label class="checkbox-inline">
						  <input type="checkbox" name="" id="passportcheck" value="">
						  Passport
						</label>
						<label class="checkbox-inline">
						  <input type="checkbox" name="" id="lainnyacheck" value="">
						  Lainnya
						</label>-->
						<?php echo $this->Form->input('CompanyResponsible.0.tanda_pengenal',array('options'=>array(0=>'Please select','KTP'=>'KTP','SIM'=>'SIM','PASSPORT'=>'PASSPORT')));?>
					  </div>
					</div>
				</td>
			</tr>
			<tr id="ktp" style="display:none">
				...
				<td>:</td>
				<td><input type="text" placeholder="ID Number" style="width:100%;"></input></td>
			</tr>
			<tr id="sim" style="display:none">
				<td><span style="margin-left: 40px;">No. SIM</span></td>
				<td>:</td>
				<td><input type="text" placeholder="Driver Number" style="width:100%;"></input></td>
			</tr>
			<tr id="passport" style="display:none">
				<td><span style="margin-left: 40px;">No. Passport</span></td>
				<td>:</td>
				<td><input type="text" placeholder="Passport Number" style="width:100%;"></input></td>
			</tr>
			<tr id="lainnya" style="display:none">
				<td><span style="margin-left: 40px;">Lainnya</span></td>
				<td>:</td>
				<td><input type="text" placeholder="Others Number" style="width:100%;"></input></td>
			</tr>
			<tr>
				<td>Jenis Kelamin</td>
				<td>:</td>
